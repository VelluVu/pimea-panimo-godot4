...
## added so a modifier can trade against those axes too, not just AVI
...
func test_stat_summary_lists_avi_and_price_with_signed_percent() -> void:
	var modifier := RunModifier.new()
	modifier.avi_threshold_multiplier = 0.85
