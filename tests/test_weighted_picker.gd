...
const WeightedPickerScript := preload("res://src/systems/toolkit/weighted_picker.gd")
const ResourceFolderScript := preload("res://src/systems/toolkit/resource_folder.gd")
